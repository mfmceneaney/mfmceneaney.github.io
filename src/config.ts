  ...
  experience: [
    {
      ...
      bullets: [
        "In the process of publishing the most precise measurement of Lambda spin transfer.",
        ...
        "Developed a generic framework for spin asymmetry analyses with maximum likelihood fitting and other advanced statistical methods, improving the efficiency of future spin asymmetry measurements.",
        "Oversaw an undergraduate research student, providing effective guidance for him to implement a machine learning approach to vertex reconstruction.",
        ...
        "Implemented, presented, and published a domain adversarial approach to domain adaptation using Graph Neural Networks (GNNs), improving signal identification of Lambda hyperons.",
        "Created a fast and intuitive python I/O interface for the CLAS12 data format, which has been extensively used for machine learning projects at CLAS12.",
      ],
    },
    {
      company: "Duke University",
